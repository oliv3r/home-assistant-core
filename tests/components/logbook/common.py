...
class MockRow:
    ...
    def __init__(
        ...
        self.context_parent_id_bin = (
            recorder.models.ulid_to_bytes_or_none(context.parent_id) if context else None
        )
        self.context_user_id_bin = (
            recorder.models.uuid_hex_to_bytes_or_none(context.user_id) if context else None
        )
        self.context_id_bin = recorder.models.ulid_to_bytes_or_none(context.id) if context else None
        self.state = None
        self.entity_id = None
        self.row_id = None
