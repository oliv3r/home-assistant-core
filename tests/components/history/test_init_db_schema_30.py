...
async def test_fetch_period_api(
    recorder_mock: recorder.Recorder, hass: HomeAssistant, hass_client: ClientSessionGenerator
) -> None:
...
async def test_history_during_period(
    recorder_mock: recorder.Recorder, hass: HomeAssistant, hass_ws_client: WebSocketGenerator
) -> None:
