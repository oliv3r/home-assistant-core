...
async def test_show_config_form(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_create_entry(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
