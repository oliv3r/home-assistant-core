...
async def test_query_limit(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_query_no_value(
    recorder_mock: recorder.Recorder, hass: HomeAssistant, caplog: pytest.LogCaptureFixture
) -> None:
...
async def test_query_from_yaml(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
