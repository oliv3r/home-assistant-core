...
async def test_setup_entry(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
    """Test setup entry."""
    config_entry = await init_integration(hass)
    assert config_entry.state == config_entries.ConfigEntryState.LOADED


async def test_unload_entry(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_setup_config(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
