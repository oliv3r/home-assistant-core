...
async def test_flow_fails_db_url(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_options_flow(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_device_state_class(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
    """Test we get the form."""
