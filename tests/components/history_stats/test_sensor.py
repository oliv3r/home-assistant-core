...
async def test_measure_multiple(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_measure_cet(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
...
async def test_device_classes(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
