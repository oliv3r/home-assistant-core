...
def test_delete_duplicates_no_duplicates(
    ...
    with recorder.util.session_scope(hass=hass) as session:
        recorder.auto_repairs.statistics.duplicates.delete_statistics_duplicates(instance, hass, session)
...
def test_delete_metadata_duplicates_no_duplicates(
    ...
    with recorder.util.session_scope(hass=hass) as session:
        instance = recorder.get_instance(hass)
        recorder.auto_repairs.statistics.duplicates.delete_statistics_meta_duplicates(instance, session)
