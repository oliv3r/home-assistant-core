...
async def test_run_history(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
    ...
    with instance.get_session() as session:
        session.add(recorder.db_schema.RecorderRuns(start=three_days_ago, created=three_days_ago))
        session.add(recorder.db_schema.RecorderRuns(start=two_days_ago, created=two_days_ago))
        session.add(recorder.db_schema.RecorderRuns(start=one_day_ago, created=one_day_ago))
        session.commit()
