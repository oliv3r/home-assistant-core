...
async def test_async_pre_backup(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
    """Test pre backup."""
    with patch(
...
async def test_async_post_backup(recorder_mock: recorder.Recorder, hass: HomeAssistant) -> None:
    """Test post backup."""
    with patch(
