...
def test_extract_include_exclude_filter_conf() -> None:
    ...
    include_filter = recorder.filters.extract_include_exclude_filter_conf(SIMPLE_INCLUDE_FILTER)
    ...
    exclude_filter = recorder.filters.extract_include_exclude_filter_conf(SIMPLE_EXCLUDE_FILTER)
    ...
    empty_include_filter = recorder.filters.extract_include_exclude_filter_conf(EMPTY_INCLUDE_FILTER)
