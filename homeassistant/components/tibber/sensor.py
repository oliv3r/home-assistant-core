        ...
        for home in self._tibber_connection.get_homes():
            ...
            for sensor_type, is_production, unit in sensors:
                ...
                last_stats = await recorder.get_instance(self.hass).async_add_executor_job(
                    recorder.statistics.get_last_statistics, self.hass, 1, statistic_id, True, set()
                )
                ...
                if not last_stats:
                    ...
                    stat = await recorder.get_instance(self.hass).async_add_executor_job(
                ...
                recorder.statistics.async_add_external_statistics(self.hass, metadata, statistics)
