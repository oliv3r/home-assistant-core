...
def _apply_entities_context_union(
    ...
    return sel.union_all(
        ...
        apply_events_context_hints(
            ...
            .outerjoin(recorder.db_schema.Events,
                       entities_cte.c.context_id_bin == recorder.db_schema.Events.context_id_bin)
        ...
        apply_states_context_hints(
            select_states_context_only()
            .select_from(entities_cte)
            .outerjoin(recorder.db_schema.States,
                       entities_cte.c.context_id_bin == recorder.db_schema.States.context_id_bin)
...
def apply_event_entity_id_matchers(
    ...
    return sqlalchemy.or_(
        ...
        & sqlalchemy.cast(recorder.db_schema.OLD_ENTITY_ID_IN_EVENT, sqlalchemy.Text()).in_(
            json_quoted_entity_ids
        ),
    )
