...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    recorder_filter = recorder.filters.extract_include_exclude_filter_conf(recorder_conf)
    logbook_filter = recorder.filters.extract_include_exclude_filter_conf(logbook_conf)
    merged_filter = recorder.filters.merge_include_exclude_filters(recorder_filter, logbook_filter)
    ...
    if not possible_merged_entities_filter.empty_filter:
        filters = recorder.filters.sqlalchemy_filter_from_include_exclude_conf(merged_filter)
