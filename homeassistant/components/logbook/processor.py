...
class ContextAugmenter:
    ...
    def augment(
        ...
        if context_user_id_bin := row.context_user_id_bin:
            data[CONTEXT_USER_ID] = recorder.models.bytes_to_uuid_hex_or_none(context_user_id_bin)
...
def _row_time_fired_timestamp(row: Row | EventAsRow) -> float:
    ...
    return row.time_fired_ts or recorder.models.process_datetime_to_timestamp(dt_util.utcnow())
